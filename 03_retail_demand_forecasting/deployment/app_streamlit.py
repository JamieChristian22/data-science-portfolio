...
st.set_page_config(page_title="03_retail_demand_forecasting Demo", layout="centered")
st.title("03 Retail Demand Forecasting — Model Demo")

ROOT = Path(__file__).resolve().parents[1]
DATA_PATH = ROOT / "data" / "daily_sales.csv"
MODEL_PATH = ROOT / "models" / "demand_forecast_rf.joblib"
