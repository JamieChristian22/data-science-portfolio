...
st.set_page_config(page_title="04_card_fraud_detection Demo", layout="centered")
st.title("04 Card Fraud Detection — Model Demo")

ROOT = Path(__file__).resolve().parents[1]
DATA_PATH = ROOT / "data" / "transactions.csv"
MODEL_PATH = ROOT / "models" / "fraud_logreg.joblib"
