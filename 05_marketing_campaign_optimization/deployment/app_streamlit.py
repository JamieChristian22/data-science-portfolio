...
st.set_page_config(page_title="05_marketing_campaign_optimization Demo", layout="centered")
st.title("05 Marketing Campaign Optimization — Model Demo")

ROOT = Path(__file__).resolve().parents[1]
DATA_PATH = ROOT / "data" / "campaign_contacts.csv"
MODEL_PATH = ROOT / "models" / "campaign_response_logreg.joblib"
