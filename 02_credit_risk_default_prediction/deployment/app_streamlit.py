...
st.set_page_config(page_title="02_credit_risk_default_prediction Demo", layout="centered")
st.title("02 Credit Risk Default Prediction — Model Demo")

ROOT = Path(__file__).resolve().parents[1]
DATA_PATH = ROOT / "data" / "credit_risk.csv"
